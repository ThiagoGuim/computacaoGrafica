...
// cylinder2.add(cylAxesHelper2);

// yellow cylinder 1
var ycylinderGeometry1 = new THREE.CylinderGeometry(0.07, 0.07, 1.0, 25);
var ycylinderMaterial1 = new THREE.MeshPhongMaterial( {color:'rgb(255,255,0)'} );
var ycylinder1 = new THREE.Mesh( ycylinderGeometry1, ycylinderMaterial1 );
cylinder2.add(ycylinder1);

// var ycylAxesHelper1 = new THREE.AxesHelper(9);
// ycylinder1.add(ycylAxesHelper1);

// yellow cylinder 2
var ycylinderGeometry2 = new THREE.CylinderGeometry(0.07, 0.07, 1.0, 25);
var ycylinderMaterial2 = new THREE.MeshPhongMaterial( {color:'rgb(255,255,0)'} );
var ycylinder2 = new THREE.Mesh( ycylinderGeometry2, ycylinderMaterial2 );
cylinder2.add(ycylinder2);

// var ycylAxesHelper2 = new THREE.AxesHelper(9);
// ycylinder2.add(ycylAxesHelper2);
...
function rotateCylinder()
{
  ...
  ycylinder1.matrixAutoUpdate = false;
  ycylinder2.matrixAutoUpdate = false;
  ...
  if(animationOn)
  {
    ...
    ycylinder1.matrix.identity(); // reset
    ycylinder2.matrix.identity(); // reset
    ...
    // yellow cylinder 1
    ycylinder1.matrix.multiply(mat4.makeRotationY(angle2)); // R1
    ycylinder1.matrix.multiply(mat4.makeTranslation(0.0, -0.5, 0.0)); // T1
    ycylinder1.matrix.multiply(mat4.makeRotationZ(degreesToRadians(90))); // R2

    // yellow cylinder 2
    ycylinder2.matrix.multiply(mat4.makeRotationY(-angle2)); // R1
    ycylinder2.matrix.multiply(mat4.makeTranslation(0.0, 0.5, 0.0)); // T1
    ycylinder2.matrix.multiply(mat4.makeRotationZ(degreesToRadians(90))); // R2
  }
}
